        ...
        <div className={styles.top}>
            ...
            <div className={styles.top__actions}>
                <p className={styles.top__details_text}>
                    <span className={styles.top__details__accent}>Старт:</span> Интурист, пл. Ленина, 13, Пятигорск, Ставропольский край 357503, Россия
                </p>

                <p className={styles.top__details_text}>
                    <span className={styles.top__details__accent}>Финиш:</span> Интурист, пл. Ленина, 13, Пятигорск, Ставропольский край 357503, Россия
                </p>
            </div>
        </div>
    );
